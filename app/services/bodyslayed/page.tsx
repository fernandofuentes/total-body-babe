...
const beforeAfterImages = [
  {
    ...
    description: 'Results after one BodySlayed session',
  },
  {
...
const faqs = [
  {
    question: 'What is BodySlayed?',
    answer: 'BodySlayed is our ultimate body transformation session that combines full-body wood therapy, LipoLaser, and body wrap treatments. It also includes one area for additional spot treatment with either lipocavitation or RF therapy.'
  },
  {
    question: 'How long is each session?',
    answer: 'Each session lasts 150 minutes, allowing time for all treatment components and ensuring thorough attention to each area.'
  },
  {
  ...
  },
  {
    ...
    answer: 'BodySlayed can treat multiple areas including abdomen, thighs, arms, back, and flanks. You\'ll also get to choose one area for additional spot treatment with either lipocavitation or RF therapy.'
  },
  {
...
export default function BodySlayedPage() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative">
        <div className="absolute inset-0">
          <Image
            src="/images/services/bodyslayed.png"
            alt="BodySlayed Treatment"
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
          <div className="max-w-3xl text-white">
            ...
            <p className="mt-6 text-xl text-gray-100">
              Ultimate session including full-body wood therapy, LipoLaser, and body wrap. Includes one 
              area for additional spot treatment with lipocavitation or RF.
            </p>
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-2">
            <div className="space-y-6 text-gray-600">
              <p>
                BodySlayed is our most comprehensive body transformation treatment, combining multiple 
                effective technologies and techniques in one powerful session. This ultimate treatment 
                starts with full-body wood therapy to stimulate circulation and break down fat deposits, 
                followed by LipoLaser treatment to target stubborn areas.
              </p>
              <p>
                The session includes a specialized body wrap to enhance detoxification and promote inch 
                loss, plus your choice of either lipocavitation or RF therapy for additional spot 
                treatment in your area of concern. This multi-faceted approach delivers maximum results 
                in a single session.
              </p>
            </div>
            <div className="space-y-6 text-gray-600">
              <div className="rounded-lg bg-gray-50 p-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
                    ...
                    <span>Full-body wood therapy</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle2 className="h-5 w-5 text-primary" />
                    <span>LipoLaser treatment</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle2 className="h-5 w-5 text-primary" />
                  ...
                  <li className="flex items-center gap-3">
                    <CheckCircle2 className="h-5 w-5 text-primary" />
                    <span>Choice of spot treatment</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="mt-16 rounded-2xl bg-primary/5 px-6 py-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-600">
            Book your BodySlayed session today and experience our most comprehensive body 
