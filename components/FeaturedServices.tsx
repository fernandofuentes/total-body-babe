    ...
    <div className="bg-white">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <div className="mt-12 text-center">
          <Link 
            href="/services" 
            className="inline-flex items-center text-lg font-semibold text-mocha hover:text-mocha/80 transition-colors"
          >
            View All Services <span aria-hidden="true" className="ml-2">→</span>
          </Link>
        </div>
      </div>
    </div>
